...
public class c02_BesBuyAssertions {
    ...
    @Test
    public void test01() {
        String istenen="https://www.bestbuy.com/";
        String actualUrl=driver.getCurrentUrl();
        Assert.assertEquals(istenen, actualUrl);

    }
    @Test
    public void test02(){
        String istenen2="Rest";
        String actual=driver.getTitle();
        Assert.assertFalse(actual.contains(istenen2));
